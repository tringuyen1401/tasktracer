defmodule TasktracerWeb.TaskControllerTest do
  use TasktracerWeb.ConnCase

  alias Tasktracer.Social

  @create_attrs %{assigned_at: ~N[2010-04-17 14:00:00.000000], description: "some description", is_complete: true, title: "some title"}
