...
function stop_click(e) {
  ...
  var stopt = btn.data('stop-time');
  var t_id = btn.data('task-id');
  var id = btn.data('time-id');
  var startt = btn.data('start-time');
...
function update_time(tb_id, starttb, endtb) {
  ...
  _jquery2.default.ajax(timeblock_path + "/" + tb_id, {
    method: "put",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: text,
...
function init() {
  if (!(0, _jquery2.default)('.tb-stop')) {
    return;
  }
  console.log("INIT");
  (0, _jquery2.default)(".tb-stop").click(stop_click);
  (0, _jquery2.default)(".tb-start").click(start_click);
  (0, _jquery2.default)(".tb-edit").click(edit_click);
}
